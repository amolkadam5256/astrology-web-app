...
const PillarCard = ({ icon, title, desc }) => (
  <div className="p-10 bg-white dark:bg-[#0d1117] rounded-3xl border border-gray-100 dark:border-white/5 hover:border-[var(--color-primary)]/50 transition-all text-center group">
    <div className="w-14 h-14 bg-gray-50 dark:bg-black/40 text-[var(--color-primary)] rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:bg-[var(--color-primary)] group-hover:text-white transition-all">
      {icon}
    </div>
    <h3 className="text-sm font-black uppercase text-[var(--color-dark)] dark:text-white mb-4 tracking-widest">
      {title}
    </h3>
    ...
    <section className="py-24 bg-gray-50 dark:bg-[var(--color-dark)]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-xl md:text-2xl font-black text-[var(--color-dark)] dark:text-white uppercase mb-4">
            The DNA of Success
          </h2>
